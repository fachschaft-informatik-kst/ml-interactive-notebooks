...
def generate_sigmoid_svg():
    ...
    # Vertikale Gitterlinien - feines Gitter (0.5er Abstände)
    for i in np.arange(x_min, x_max + 0.1, 0.5):
    ...
    # Vertikale Gitterlinien - normales Gitter (1er Abstände)
